...
function ShareModal({ isOpen, onClose, referralCode, userName, toast }: { isOpen: boolean; onClose: () => void; referralCode: string; userName: string; toast: any }) {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black animate-in fade-in duration-300 cursor-orange" onClick={onClose}>
      <div className="h-screen flex flex-col items-center justify-center relative px-4 md:px-8 cursor-orange" onClick={(e) => e.stopPropagation()}>

        {/* Close Button - Upper Right Corner */}
        <button
          onClick={onClose}
          className="absolute top-6 md:top-8 right-6 md:right-8 p-2 md:p-3 text-white hover:scale-125 hover:opacity-70 active:scale-110 transition-all duration-200 animate-in fade-in slide-in-from-top-4 duration-500 delay-200 z-10 cursor-orange-pointer"
        ...
        <div className="w-full max-w-2xl animate-in fade-in zoom-in duration-500">
          ...
          <div className="text-center mb-12 md:mb-16">
            <div className="bg-white/5 border border-white/20 rounded-lg p-6 md:p-8 backdrop-blur-sm animate-in fade-in duration-500 delay-100 hover:border-white/40 transition-colors duration-300 cursor-orange-pointer" onClick={handleCopyLink}>
              <input
                type="text"
                value={shareUrl}
                readOnly
                className="w-full bg-transparent text-white text-center text-lg md:text-xl lg:text-2xl font-black break-all outline-none cursor-orange-pointer select-all placeholder-white/40"
          ...
          <div className="flex justify-center items-center gap-6 md:gap-8 mb-16 md:mb-20 flex-wrap">
            ...
            <button
              ...
              className="text-white hover:scale-125 hover:drop-shadow-[0_0_12px_rgba(37,211,102,0.6)] active:scale-95 transition-all duration-300 animate-in fade-in slide-in-from-bottom-4 duration-500 delay-100 transform origin-center cursor-orange-pointer"
            ...
            <button
              ...
              className="text-white hover:scale-125 hover:drop-shadow-[0_0_12px_rgba(0,136,204,0.6)] active:scale-95 transition-all duration-300 animate-in fade-in slide-in-from-bottom-4 duration-500 delay-150 transform origin-center cursor-orange-pointer"
            ...
            <button
              ...
              className="text-white hover:scale-125 hover:drop-shadow-[0_0_12px_rgba(0,132,250,0.6)] active:scale-95 transition-all duration-300 animate-in fade-in slide-in-from-bottom-4 duration-500 delay-200 transform origin-center cursor-orange-pointer"
            ...
            <button
              ...
              className="text-white hover:scale-125 hover:drop-shadow-[0_0_12px_rgba(224,33,103,0.6)] active:scale-95 transition-all duration-300 animate-in fade-in slide-in-from-bottom-4 duration-500 delay-250 transform origin-center cursor-orange-pointer"
            ...
            <button
              ...
              className="text-white hover:scale-125 hover:drop-shadow-[0_0_12px_rgba(0,0,0,0.6)] active:scale-95 transition-all duration-300 animate-in fade-in slide-in-from-bottom-4 duration-500 delay-300 transform origin-center cursor-orange-pointer"
            ...
            <button
              ...
              className="text-white hover:scale-125 hover:drop-shadow-[0_0_12px_rgba(59,89,152,0.6)] active:scale-95 transition-all duration-300 animate-in fade-in slide-in-from-bottom-4 duration-500 delay-350 transform origin-center cursor-orange-pointer"
            ...
            <button
              ...
              className="text-white hover:scale-125 hover:drop-shadow-[0_0_12px_rgba(221,75,57,0.6)] active:scale-95 transition-all duration-300 animate-in fade-in slide-in-from-bottom-4 duration-500 delay-400 transform origin-center cursor-orange-pointer"
        ...
        <div className="absolute bottom-6 md:bottom-8 left-1/2 -translate-x-1/2 flex items-center gap-4 md:gap-6 animate-in fade-in slide-in-from-bottom-4 duration-500 delay-500">
          ...
          <button
            ...
            className={`p-2 md:p-3 text-white transition-all duration-300 hover:scale-125 active:scale-95 transform cursor-orange-pointer ${
              copied 
