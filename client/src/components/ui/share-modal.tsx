        ...
        <div className="p-4 md:p-6 space-y-6">
          ...
          <div className="bg-muted p-3 md:p-4 border border-muted-foreground/20">
            <div className="grid grid-cols-2 gap-4 text-center">
              <div>
                <div className="text-lg font-black text-primary">15%</div>
                <TechnicalLabel text="DIRECT COMMISSION" className="text-muted-foreground text-xs" />
              </div>
              <div>
                <div className="text-lg font-black text-foreground">TX-POINTS</div>
                <TechnicalLabel text="INSTANT CREDIT" className="text-muted-foreground text-xs" />
              </div>
            </div>
          </div>
        </div>
