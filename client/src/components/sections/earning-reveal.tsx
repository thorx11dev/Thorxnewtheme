  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 pt-8">
        ...
        {/* Split Screen Cards */}
        <div className="grid md:grid-cols-2 gap-0 mb-12 max-w-6xl mx-auto h-96">
          {/* Dark Section */}
          <div className="split-card bg-black text-white p-12 relative h-full">
            {/* Corner Number */}
          ...
          {/* Orange Section */}
          <div className="split-card bg-primary text-white p-12 relative h-full overflow-hidden">
            {/* Next button */}
